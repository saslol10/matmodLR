...
if Q > 0:
    y1 = (((-(q/2)) + math.sqrt(Q)) ** (1/3)) + (((-(q/2)) - math.sqrt(Q)) ** (1/3))

    y2 = (-1/2) * ((((-(q/2)) + math.sqrt(Q)) ** (1/3)) + (((-(q/2)) - math.sqrt(Q)) ** (1/3))) + complex(0, math.sqrt(3)/2) * ((((-(q/2)) + math.sqrt(Q)) ** (1/3)) + (((-(q/2)) - math.sqrt(Q)) ** (1/3)))

    y3 = (-1/2) * ((((-(q/2)) + math.sqrt(Q)) ** (1/3)) + (((-(q/2)) - math.sqrt(Q)) ** (1/3))) - complex(0, math.sqrt(3)/2) * ((((-(q/2)) + math.sqrt(Q)) ** (1/3)) + (((-(q/2)) - math.sqrt(Q)) ** (1/3)))
